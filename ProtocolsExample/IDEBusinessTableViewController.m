//
//  IDEBusinessTableViewController.m
//  ProtocolsExample
//
...
#import "IDEBusinessTableViewController.h"

@interface IDEBusinessTableViewController ()

@end

@implementation IDEBusinessTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    AppDelegate* appDelegate = (AppDelegate*)[[UIApplication sharedApplication]delegate];
    self.businesses = appDelegate.businesses;
